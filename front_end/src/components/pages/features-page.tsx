        ...
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-emerald-200/80 max-w-3xl mx-auto leading-relaxed">
              Explore all the features that make FarmConnect the most advanced agricultural platform
            </p>
          </motion.div>
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-emerald-200/80 max-w-3xl mx-auto">
              See how FarmConnect transforms traditional farming practices with cutting-edge blockchain technology
            </p>
          </motion.div>
